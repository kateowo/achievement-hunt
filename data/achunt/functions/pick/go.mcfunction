...
execute if score achievement internal matches 2 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Not Today, Thank You ","color":"green"},{"text":"Block a projectile using your shield.","color":"gray"}]
...
execute if score achievement internal matches 4 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Diamonds! ","color":"green"},{"text":"Acquire diamonds","color":"gray"}]
execute if score achievement internal matches 5 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"We Need to Go Deeper ","color":"green"},{"text":"Build, light and enter a Nether Portal","color":"gray"}]
execute if score achievement internal matches 6 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Cover Me With Diamonds ","color":"green"},{"text":"Diamond armor saves lives","color":"gray"}]
execute if score achievement internal matches 7 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Enchanter ","color":"green"},{"text":"Enchant an item at an Enchantment Table","color":"gray"}]
execute if score achievement internal matches 8 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Zombie Doctor ","color":"green"},{"text":"Weaken and then cure a Zombie Villager","color":"gray"}]
...
execute if score achievement internal matches 14 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"This Boat Has Legs ","color":"green"},{"text":"Ride a Strider with a Warped Fungus on a Stick","color":"gray"}]
execute if score achievement internal matches 15 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"War Pigs ","color":"green"},{"text":"Loot a chest in a Bastion Remnant","color":"gray"}]
execute if score achievement internal matches 16 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Country Lode, Take Me Home ","color":"green"},{"text":"Use a compass on a Lodestone","color":"gray"}]
execute if score achievement internal matches 17 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Spooky Scary Skeleton ","color":"green"},{"text":"Obtain a Wither Skeleton's skull","color":"gray"}]
execute if score achievement internal matches 18 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Into Fire ","color":"green"},{"text":"Relieve a Blaze of its rod","color":"gray"}]
execute if score achievement internal matches 19 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Local Brewery ","color":"green"},{"text":"Brew a potion","color":"gray"}]
execute if score achievement internal matches 20 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Is It a Bird? ","color":"green"},{"text":"Look at a parrot through a spyglass","color":"gray"}]
execute if score achievement internal matches 21 run tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"⭐","color":"green"},{"text":"] ","color":"dark_gray"},{"text":"Monster Hunter ","color":"green"},{"text":"Kill any hostile monster","color":"gray"}]
